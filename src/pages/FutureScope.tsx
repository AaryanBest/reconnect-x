...
const FutureScope = () => {
  ...
  const milestones = [
    { year: "2025 Q1", title: "Mobile App Launch", status: "completed" },
    { year: "2025 Q2", title: "AI Mentor Matching", status: "in-progress" },
    { year: "2025 Q3", title: "Blockchain Integration", status: "upcoming" },
    { year: "2025 Q4", title: "Global Expansion", status: "upcoming" },
    { year: "2026", title: "VR/AR Features", status: "planned" }
  ];

  const impactMetrics = [
    { metric: "Alumni Connected", current: "50,000", target: "1M+", growth: "+1900%" },
    { metric: "Institutions", current: "200", target: "2,000", growth: "+900%" },
    { metric: "Job Placements", current: "5,000", target: "100K", growth: "+1900%" },
    { metric: "Events Hosted", current: "500", target: "10K", growth: "+1900%" }
  ];

  const technologies = [
    { name: "Artificial Intelligence", description: "Machine Learning & Natural Language Processing", color: "text-primary" },
    { name: "Blockchain", description: "Ethereum & Hyperledger for verification", color: "text-accent" },
    { name: "Cloud Infrastructure", description: "AWS & Microsoft Azure for scalability", color: "text-success" },
    { name: "Mobile Technology", description: "React Native & Progressive Web Apps", color: "text-orange-500" },
    { name: "Analytics", description: "Big Data & Real-time Processing", color: "text-purple-500" },
    { name: "Security", description: "End-to-end encryption & compliance", color: "text-red-500" }
  ];

  const getStatusColor = (status: string) => {
    switch (status) {
      case "completed": return "bg-success text-success-foreground";
      case "in-development": case "in-progress": return "bg-primary text-primary-foreground";
      case "planned": case "upcoming": return "bg-accent text-accent-foreground";
